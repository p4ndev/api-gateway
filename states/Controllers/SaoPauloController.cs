...
[ApiController]
[Route("[controller]")]
public class SaoPauloController : ControllerBase {

    private readonly ISaoPauloServices _services;

    public SaoPauloController(ISaoPauloServices services) => _services = services;
